...
//so npm i dotenv karne ke baad ek file banaeyge .env karke server folder mai then usmai simple DB_USERNAME=abhishekmintu and DB_PASSWORD=J%40rutnim5 likhenge and then index.js mai esko import karke dotenv.config() and then second last line maiconst USERNAME =process.env.DB_USERNAME; and const PASSWORD =process.env.DB_PASSWORD; lekhenge and then Connection ke call mai USERNAME AND PASSWORD as argument bhej denge and the db mau username and password as argument recieve karke usko url mai dynamically daal denge.
